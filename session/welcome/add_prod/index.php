  ...
  <div class='collapse navbar-collapse' id='navbarTogglerDemo02'>
    <ul class='navbar-nav mr-auto mt-2 mt-lg-0'>
     ...
     <a class='navbar-brand' href='#'></a>  
      <li class='nav-item'>
       <form class='nav' method='post' action='./'><input name='user' type='hidden' value='".$_SESSION['id']."'> <input class='btn disabled' disabled type='submit' value='Vender um produto.'></form>
      </li>
      <a class='navbar-brand' href='#'></a>
        <li class='nav-item'>
...
<br>
            <!-- Send button --><br>
            <button class='btn btn-info btn-block' type='submit'>OK</button> <a class='btn btn-danger btn-block' href='/proferta/session/welcome'> Voltar </a>
